...
```
wget https://github.com/gimesketvirtadieni/slimstreamer/releases/download/v0.6.0-beta/SlimStreamer_v0.6.0-beta_x86_64.zip
unzip SlimStreamer_v0.6.0-beta_x86_64.zip
./SlimStreamer
```
