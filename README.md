...
In fact, audio streaming is done transparently by SlimStreamer and [SlimPlexos](https://github.com/gimesketvirtadieni/slimplexor) (an ALSA plugin) behind the scene.
