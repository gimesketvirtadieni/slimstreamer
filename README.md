...
```
wget https://github.com/gimesketvirtadieni/slimstreamer/releases/download/v0.4.0-alpha/SlimStreamer_v0.4.0-alpha_amd64.zip
unzip SlimStreamer_v0.4.0-alpha_amd64.zip
./SlimStreamer
```
