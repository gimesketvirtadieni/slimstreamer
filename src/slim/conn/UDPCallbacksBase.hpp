...
namespace slim
{
	namespace conn
	{
		...
		class UDPCallbacksBase
		{
			public:
				UDPCallbacksBase() = default;

				// using Rule Of Zero
			   ~UDPCallbacksBase() = default;
				UDPCallbacksBase(const UDPCallbacksBase&) = delete;             // non-copyable
				UDPCallbacksBase& operator=(const UDPCallbacksBase&) = delete;  // non-assignable
				UDPCallbacksBase(UDPCallbacksBase&& rhs) = default;
				UDPCallbacksBase& operator=(UDPCallbacksBase&& rhs) = default;
